      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8">
        <div className="flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start">
          ...
          <p className="text-gray-300 py-4 max-x-md text-justify">
            Result-oriented and innovative full-stack developer with 4+ years of
            experience specializing in web technologies including React, .NET
            Core, .NET Framework, and JavaScript. Proven expertise in delivering
            high-quality software solutions through Third-Party Integration,
            Component-Based Architecture, State Management, and Agile
            Development Practices. Proficient in implementing JWT
            Authentication, API Development, and optimizing performance for
            seamless user experiences. Adept at collaborating with
            cross-functional teams in dynamic environments to drive innovation
            and deliver exceptional customer-centric solutions.{" "}
          </p>
